...
INTEGRATION_TEST ?= NO
DATABASE_DSN ?= postgres://postgres:mysecretpassword@localhost:5432/ext-data-domain?sslmode=disable
DATABASE_DSN_CI ?= "postgres://test:123456@localhost:5432/ext-data-domain?sslmode=disable"
