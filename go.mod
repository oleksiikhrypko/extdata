module ext-data-domain

go 1.21.6

require (
	github.com/99designs/gqlgen v0.17.44
	github.com/Slyngshot-Team/packages/auth v0.1.11
	github.com/Slyngshot-Team/packages/config v0.1.0
	github.com/Slyngshot-Team/packages/filestorage v1.0.5
	github.com/Slyngshot-Team/packages/log v0.0.7
	github.com/Slyngshot-Team/packages/service v0.0.10
	github.com/Slyngshot-Team/packages/storage v0.0.27
	github.com/Slyngshot-Team/packages/xerrors v0.0.9
